	...
	<Html>
		...
		>
			<Body className="bg-white font-linear">
				<Preview>Your login code for {company}</Preview>
				<Container className="mx-auto my-0 max-w-[560px] px-0 pt-5 pb-12">
					...
					<Link href={siteUrl} className="text-[#b4becc] text-[14px]">
						Linear
					</Link>
				</Container>
			</Body>
...
OTP.PreviewProps = {
	...
	loginUrl: 'http://localhost:3000/admin/login?otp',
} as OTPProps
